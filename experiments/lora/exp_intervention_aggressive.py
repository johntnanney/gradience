"""Aggressive Intervention: How Far Can We Push Rank Reduction?"""
...
def main():
    ...
    parser.add_argument("--output-dir", default="./intervention_aggressive")
    ...
    conditions = {
        ...
        "moderate_r32": {"base_rank": 64, "rank_pattern": {"v_lin": 32, "lin2": 32}, "desc": "V/FFN→32"},
        "aggressive_r16": {"base_rank": 64, "rank_pattern": {"v_lin": 16, "lin2": 16}, "desc": "V/FFN→16"},
        "extreme_r8": {"base_rank": 64, "rank_pattern": {"v_lin": 8, "lin2": 8}, "desc": "V/FFN→8"},
    }
    print("="*70 + "\nAGGRESSIVE INTERVENTION STUDY\n" + "="*70)
    ...
    print("\n" + "="*70 + "\nRESULTS\n" + "="*70)
    print(f"\n{'Condition':<18} {'Accuracy':<16} {'Params':<12} {'Savings':<10} {'Δ Acc':<10}")
    print("-"*66)

...
def test_priority_score_ordering():
    ...
    for i, layer_info in enumerate(expected_order):
        ...
        print(
            f"     spread={layer_info['spread']}, uniform_mult={layer_info['uniform_mult']:.2f}, spread_norm={layer_info['spread_norm']:.2f}"
        )
...
def test_priority_edge_cases():
    ...
    if len(analysis["all_layers_with_disagreement"]) >= 2:
        ...
        assert abs(score1 - score2) < 0.001, "Identical layers should have same priority_score"

...
def test_schema_versioning():
    ...
    custom_config = {"quantile_threshold": 0.60, "uniform_mult_gate": 1.8, "metric": "energy_share"}
    ...
    if computed_with.get("git_sha"):
        ...
        print("  ✓ git_sha: not available (expected in non-git environments)")
    ...
    print("  ✓ Custom configuration correctly captured")
    ...
    try:
        ...
        assert parsed["disagreement_config"]["algorithm_name"] == "energy_share_uniform_multiplier_gate", (
            "Algorithm name lost"
        )
...
def test_configuration_combinations():
    ...
    test_configs = [
        {"name": "Default configuration", "config": None},
        {
    ...
    for test_case in test_configs:
        ...
        print("  ✓ Configuration captured correctly")

...
def test_bench_udr_config_parsing():
    ...
    config_with_udr = {
        ...
        "audit": {"base_model": "distilbert-base-uncased", "base_norms_cache": "/tmp/cache", "compute_udr": True},
        "lora": {"probe_r": 16},
        "train": {"seed": 42},
    }

    # Sample config without UDR
    config_without_udr = {"model": {"name": "distilbert-base-uncased"}, "lora": {"probe_r": 16}, "train": {"seed": 42}}
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with patch.object(protocol, "audit_lora_peft_dir") as mock_audit:
            ...
            mock_audit.assert_called_with(
                probe_dir, base_model_id="distilbert-base-uncased", base_norms_cache="/tmp/cache", compute_udr=True
            )
...
def test_bench_report_udr_integration():
    ...
    audit_data_without_udr = {"summary": {"utilization_mean": 0.5, "n_layers_with_udr": 0}, "layers": []}

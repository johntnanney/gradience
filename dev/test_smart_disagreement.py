...
def test_edge_cases():
    ...
    consensus_layers = [
        MockLayer(
            "consensus.layer",
            {"energy_threshold": {"k": 4, "confidence": 0.90}, "knee_elbow": {"k": 4, "confidence": 0.85}},
        )
    ]
    ...
    low_importance_layers = [
        ...
        MockLayer(
            "unimportant.layer2",
            {"energy_threshold": {"k": 7, "confidence": 0.90}, "knee_elbow": {"k": 1, "confidence": 0.80}},
            frob_sq=0.01,
            params=100,
        ),
    ]
    ...
    flat_distribution_layers = [
        ...
        MockLayer(
            "layer3",
            {"energy_threshold": {"k": 7, "confidence": 0.90}, "knee_elbow": {"k": 1, "confidence": 0.85}},
            frob_sq=5.1 * 5.1,
            params=1000,
            utilization=0.5,
        ),  # importance ≈ 5.1
        MockLayer(
            "layer4",
            {"energy_threshold": {"k": 4, "confidence": 0.90}, "knee_elbow": {"k": 3, "confidence": 0.80}},
            frob_sq=5.0 * 5.0,
            params=1000,
            utilization=0.5,
        ),  # importance ≈ 5.0
    ...
    single_dominant_layers = [
        ...
        MockLayer(
            "normal_layer2",
            {"energy_threshold": {"k": 7, "confidence": 0.90}, "knee_elbow": {"k": 1, "confidence": 0.75}},
            frob_sq=1.5 * 1.5,
            params=1000,
            utilization=0.4,
        ),
    ...
    two_dominant_layers = [
        ...
        MockLayer(
            "normal_layer2",
            {"energy_threshold": {"k": 5, "confidence": 0.90}, "knee_elbow": {"k": 2, "confidence": 0.75}},
            frob_sq=1.2 * 1.2,
            params=1000,
            utilization=0.3,
        ),

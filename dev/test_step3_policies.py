...
class TestPolicyIntegration:
    ...
    def test_mathematical_correctness_verification(self):
        ...
        print("📊 Entropy Effective Rank (Roy & Vetterli):")
        ...
        print(
            f"  k = {entropy_result.k} (ceil={entropy_result.details['k_ceil']}, round={entropy_result.details['k_round']})"
        )
        print()
        ...
        print("📊 Knee Detection (Kneedle-style):")

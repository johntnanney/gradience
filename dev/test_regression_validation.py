...
def test_regression_catches_reversion():
    ...
    for test_case in broken_configs:
        ...
        if broken_flagged > 0:
            print("     Incorrectly flagged layers:")
    ...
    print("\n🎯 CONCLUSION:")
    print("   • Correct logic: ✅ Passes regression test")
    print("   • Broken logic: ❌ Fails regression test")
    print("   • The regression test effectively prevents reversions!")

...
def test_bench_integration():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        mock_compression_configs = {
            "energy_p90": {"policy_type": "energy", "suggested_r": 8, "actual_r": 8, "status": "ready"},
            "knee_p90": {"policy_type": "knee", "suggested_r": 4, "actual_r": 4, "status": "ready"},
            "erank_p90": {"policy_type": "erank", "suggested_r": 6, "actual_r": 6, "status": "ready"},
        }

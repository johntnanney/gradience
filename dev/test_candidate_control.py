...
def create_mock_audit_data():
    ...
    return {
        ...
        "per_layer_suggestions": {"rank_pattern": {"module1": 4, "module2": 6, "module3": 8}},
    }
...
def create_mock_config():
    ...
    return {
        "compression": {"allowed_ranks": [1, 2, 3, 4, 6, 8, 12, 16]},
        "lora": {"probe_r": 16, "alpha": 16, "dropout": 0.1, "target_modules": ["query", "value"]},
    }

        ...
        if policy in result.policy_global_suggestions:
            ...
            for layer in result.layers:
                if (
                    ...
                    and policy in layer.rank_suggestions
                    and "k" in layer.rank_suggestions[policy]
                ):
            ...
            if values:
                ...
                print(
                    f"  Computed: median={computed['uniform_median']}, p90={computed['uniform_p90']}, max={computed['uniform_max']}"
                )

...
class HangDiagnostics:
    ...
    @staticmethod
    def get_log_tail(log_file: Path | None, lines: int = 20) -> list[str]:
    ...
    @classmethod
    def dump_all_diagnostics(
        cls, stage_name: str, timeout_minutes: int, log_file: Path | None = None, output_dir: Path | None = None
    ) -> str:

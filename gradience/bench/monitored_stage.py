...
class monitored_stage:
    ...
    def __init__(self, 
        ...
        # Watchdog context
        self.watchdog: Optional[WatchdogContext] = None
    ...
    def __enter__(self):
        ...
        start_heartbeat(self.stage_name, self.output_dir, self.heartbeat_interval, 
                       self.log_to_file, self.seed)
...
def monitor_evaluation(stage_name: str, output_dir: Optional[Union[str, Path]] = None, **kwargs):

...
class PhaseTransitionMetrics:
    ...
    # Autocorrelation
    autocorr_time: float | None  # Integrated autocorrelation time
    autocorr_1: float | None  # Lag-1 autocorrelation

    # Fluctuation measures
    variance: float  # Variance of observable
    variance_ratio: float | None  # Ratio to baseline variance
...
class PhaseTransitionTracker:
    ...
    _baseline_variance: float | None = None

...
from .telemetry import SummaryGenerator, TelemetryWriter
...
class GradienceController:
    ...
    # Internal components
    _guard: Guard | None = field(default=None, repr=False)
    _spectral: SpectralAnalyzer | None = field(default=None, repr=False)
    _telemetry: TelemetryWriter | None = field(default=None, repr=False)
    _summary: SummaryGenerator | None = field(default=None, repr=False)

    # State
    _model = None
    _current_loss: float | None = None
    ...
    def initialize(
        ...
        get_lr_fn: Callable[[], float] | None = None,
        set_lr_fn: Callable[[float], None] | None = None,
    ) -> None:
        """

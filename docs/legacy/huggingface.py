...
class GradienceCallback:
    ...
    # Internal
    _controller: GradienceController | None = field(default=None, repr=False)
    _trainer: Any = field(default=None, repr=False)
    _current_loss: float | None = field(default=None, repr=False)
    ...
    def _extract_loss(self, state) -> float | None:

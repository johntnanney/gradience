...
class SimpleClassificationDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        enc = self.tokenizer(text, padding="max_length", max_length=32, truncation=True, return_tensors="pt")
        return {
...
for epoch in range(20):
    ...
    print(
        f"{epoch:>5} {train_acc * 100:>7.1f}% {test_acc * 100:>7.1f}% {epoch_loss / len(train_loader):>8.4f} {spec.kappa:>10.1f} {spec.effective_rank:>8.1f}"
    )

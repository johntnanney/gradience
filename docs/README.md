...
1. **Product** — what Gradience does today and what is safe to rely on.
   - [`docs/product/README.md`](product/README.md)
2. **Workflows** — how to run and interpret concrete workflows.
   - [`docs/workflows/README.md`](workflows/README.md)
3. **Architecture** — substrate layers, seams, boundaries, and design decisions.
   - [`docs/architecture/README.md`](architecture/README.md)
4. **Research** — curated entry into sidecar findings and Route 2 synthesis.

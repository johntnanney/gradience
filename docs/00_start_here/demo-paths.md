...
2. [`../product/product-validation.md`](../product/product-validation.md)
3. [`../product/example-gallery.md`](../product/example-gallery.md)
4. [`../workflows/getting-started-preflight.md`](../workflows/getting-started-preflight.md)

## Path B — Broadened Route 2 (30–45 min)

1. [`../architecture/broadened-substrate-scope.md`](../architecture/broadened-substrate-scope.md)
2. [`../product/checkpoint-triage-alpha-workflow.md`](../product/checkpoint-triage-alpha-workflow.md)
3. [`../product/checkpoint-triage-alpha-scope.md`](../product/checkpoint-triage-alpha-scope.md)
4. [`../research/route2-summary.md`](../research/route2-summary.md)

## Path C — Research Program (45–60 min)

1. [`../research/summaries/settled-open-next.md`](../research/summaries/settled-open-next.md)

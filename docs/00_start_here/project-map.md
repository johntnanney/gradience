...
Gradience is an evidence-aware compatibility and triage system for learned variants from a shared base model.
...
- What the research found: [`../research/README.md`](../research/README.md)
- How to maintain/extend: [`../development/README.md`](../development/README.md)

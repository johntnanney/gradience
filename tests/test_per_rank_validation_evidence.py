...
class TestPerRankValidationEvidence(unittest.TestCase):
    ...
    def test_per_rank_validation_evidence_statements(self):
        ...
        assert "r=32** is ⚠️  **conditionally promising**" in md_content, "Missing conditionally promising statement for r=32"
    ...
    def test_evidence_based_transparency_message(self):
        ...
        assert "which compression levels can be trusted across independent random seeds" in md_content, "Missing trust statement"

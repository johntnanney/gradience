...
class TestPackagingResources:
    ...
    def test_main_configs_accessible(self):
        ...
        expected_configs = ["distilbert_sst2.yaml", "distilbert_sst2_ci.yaml", "mistral_gsm8k_certifiable_seed42.yaml"]
    ...
    def test_gpu_smoke_configs_accessible(self):
        ...
        try:
            gpu_smoke_files = list(importlib.resources.files(gradience.bench.configs).joinpath("gpu_smoke").iterdir())
        except Exception as e:
    ...
    def test_config_content_readable(self):
        ...
        try:
            ...
            config_content = (
                importlib.resources.files(gradience.bench.configs).joinpath("distilbert_sst2.yaml").read_text()
            )
            ...
            policy_content = (
                importlib.resources.files(gradience.bench.policies).joinpath("safe_uniform.yaml").read_text()
            )

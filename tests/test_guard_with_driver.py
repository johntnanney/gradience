...
class TestGuardWithDriver(unittest.TestCase):
    ...
    def test_basic_gradient_explosion(self):
        ...
        driver = HFCallbackDriver(callback_class=GradienceCallback, callback_config=scenario.guard_config)
    ...
    def test_cooldown_protection(self):
        ...
        scenario = create_cooldown_scenario(first_step=10, second_step=15, cooldown_steps=20)
        ...
        try:
            ...
            result.assert_sequence(
                ["GUARD_INIT", "GUARD_TRIGGERED", "GUARD_ROLLBACK", "GUARD_TRIGGERED", "GUARD_ABORT"]
            )
    ...
    def test_max_rollbacks_protection(self):
        ...
        scenario = create_max_rollbacks_scenario(first_step=10, second_step=11, max_rollbacks=1)

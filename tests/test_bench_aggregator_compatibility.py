...
class TestBenchAggregatorCompatibility(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_report_data = {
            ...
            "env": {"python_version": "3.10.0", "torch_version": "2.0.0", "seed": 42},
            "probe_quality_gate": {
            ...
            "probe": {"rank": 16, "params": 10240, "accuracy": 0.85},
            "compressed": {
                "uniform_median": {
                    "rank": 4,
                    "params": 2560,
            ...
            "summary": {
                ...
                "best_compression": {"variant": "uniform_median", "param_reduction": 0.75},
            },
        }

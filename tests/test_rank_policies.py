...
class TestEntropyEffectiveRank:
    ...
    def test_concentrated_spectrum(self):
        ...
        assert effective_rank < 1.5, f"Concentrated spectrum should give low eRank, got {effective_rank}"
    ...
    def test_monotonic_behavior(self):
        ...
        assert erank2 >= erank1, f"More balanced spectrum should have higher eRank: {erank1} vs {erank2}"
...
class TestKneeElbowDetection:
    ...
    def test_obvious_elbow(self):
        ...
        expected_k = 3
        assert abs(result.k - expected_k) <= 1, f"Expected elbow detection around k={expected_k}, got k={result.k}"
...
class TestAuditSchemaIntegration:
    ...
    def test_rank_suggestions_schema(self):
        ...
        for policy_name in policy_names:
            ...
            rank_suggestions[policy_name] = {"k": result.k, "confidence": result.confidence, "details": result.details}
        ...
        for policy_name, suggestion in rank_suggestions.items():
            ...
            assert isinstance(suggestion["confidence"], (int, float)), (
                f"Policy {policy_name} 'confidence' should be numeric"
            )
    ...
    def test_new_audit_fields(self):
        ...
        mock_audit_result = {
            ...
            "policy_global_suggestions": {
                "energy_threshold": {"uniform_median": 4.0, "uniform_p90": 6.0, "uniform_max": 8.0, "n_layers": 10},
                "knee_elbow": {"uniform_median": 2.0, "uniform_p90": 3.0, "uniform_max": 4.0, "n_layers": 10},
            },
        }
...
class TestSchemaStability:
    ...
    def test_schema_version_field(self):
        ...
        mock_result = {"total_lora_params": 1000, "n_layers": 1, "rank_policy_schema_version": 1}
    ...
    def test_structured_policy_schema(self):
        ...
        mock_policies = {
            "metadata": {
                ...
                "default_parameters": {"energy_threshold": {"threshold": 0.90}, "knee_elbow": {}},
            },
            "global_statistics": {
                "energy_threshold": {"uniform_median": 4.0, "uniform_p90": 6.0, "uniform_max": 8.0, "n_layers": 1}
            },
            "per_layer": [
                {
                    ...
                    "suggestions": {
                        "energy_threshold": {
                            "k": 4,
                            "confidence": 0.90,
                            "metadata": {"threshold_used": 0.90, "energy_captured": 0.92, "total_energy": 100.0},
                        }
                    },
                }
            ],

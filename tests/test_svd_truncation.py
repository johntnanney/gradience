...
class TestAdapterIO:
    ...
    def test_error_handling(self, temp_peft_dir):
        ...
        with pytest.raises(FileNotFoundError):
            svd_truncate_peft_dir(peft_dir=temp_peft_dir, out_dir=temp_peft_dir.parent / "output", target_rank=8)
    ...
    def test_parameter_scaling_tripwire(self, temp_peft_dir):
        ...
        for target_rank, expected_params in target_ranks_and_expected_params:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                report = svd_truncate_peft_dir(peft_dir=source_dir, out_dir=output_dir, target_rank=target_rank)
    ...
    def test_audit_mixup_prevention(self, temp_peft_dir):
        ...
        report = svd_truncate_peft_dir(peft_dir=temp_peft_dir, out_dir=output_dir, target_rank=8)

...
class TestUDRIntegrationSimple:
    ...
    def test_audit_json_schema_complete(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            required_top_level = ["n_layers", "total_lora_params", "stable_rank_mean", "utilization_mean"]
            ...
            if "layers" in audit_result:
                ...
                required_layer_fields = ["delta_sigma_max", "delta_fro_norm", "scale", "base_sigma_max", "udr", "sdi"]
    ...
    def test_realistic_udr_values(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            print("✅ UDR values in realistic ranges:")

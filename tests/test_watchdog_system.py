...
from gradience.bench.watchdog import (
    HangDiagnostics, WatchdogTimer, WatchdogContext, 
    setup_stack_trace_handler
)
from gradience.bench.monitored_stage import (
    monitored_stage, monitor_evaluation, monitor_training, 
    monitor_file_operations, setup_global_monitoring
)
...
class TestHangDiagnostics(unittest.TestCase):
    ...
    def test_comprehensive_diagnostic_dump(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            report = HangDiagnostics.dump_all_diagnostics(
                "test_stage", 30, log_file, temp_path
            )
...
class TestWatchdogTimer(unittest.TestCase):
    ...
    def test_basic_watchdog_lifecycle(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            watchdog = WatchdogTimer("test_stage", timeout_minutes=0.05,  # 3 second timeout
...
class TestMonitoredStage(unittest.TestCase):
    ...
    def test_monitored_stage_basic_usage(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with monitored_stage("test_stage", output_dir=temp_path, 
                               timeout_minutes=1, enable_watchdog=False) as stage:
    ...
    def test_custom_timeout_override(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            stage = monitor_evaluation("test", output_dir=temp_path, 
                                     timeout_minutes=60, enable_watchdog=False)
...
class TestIntegration(unittest.TestCase):
    ...
    def test_end_to_end_monitoring(self, mock_print):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with monitor_evaluation("integration_test", output_dir=temp_path, 
                                  timeout_minutes=1, enable_watchdog=False) as stage:

...
"""
    ...
    def test_compression_config_generation_with_svd(self):
        ...
        audit_summary = {
            ...
            "current_r": 16,
            "per_layer_ranks": {"q_lin": 12, "k_lin": 10, "v_lin": 14, "out_lin": 11},
        ...
        compression_config = {
            "variants": [
                ...
                {"name": "svd_trunc_r4", "method": "svd_truncate", "rank_source": 4, "post_tune": {"enabled": False}},
            ],
            "allowed_ranks": [2, 4, 8, 16],
            "acc_tolerance": 0.02,
        }
    ...
    def test_svd_artifact_structure(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # 1. Adapter config
            config = {"r": 8, "lora_alpha": 8.0, "target_modules": ["q_lin", "v_lin"], "peft_type": "LORA"}

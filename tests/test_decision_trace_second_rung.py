...
def create_mock_audit_data(
    utilization_mean: float = 0.5, stable_rank_mean: float = 12.0, suggested_r_global_median: float = 20.0
) -> dict:
...
def test_decision_trace_schema_stability():
    ...
    audit_data = create_mock_audit_data(utilization_mean=0.25, stable_rank_mean=6.0, suggested_r_global_median=20.0)

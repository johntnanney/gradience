...
def demo_predefined_scenarios():
    ...
    cooldown_scenario = create_cooldown_scenario(first_step=10, second_step=15, cooldown_steps=20)

    driver = HFCallbackDriver(callback_class=GradienceCallback, callback_config=cooldown_scenario.guard_config)

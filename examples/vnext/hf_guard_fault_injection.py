...
class TinyConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size=100, hidden_size=32, intermediate_size=64, num_hidden_layers=2, **kwargs):
        ...
        for event in events:
            ...
            # Check canonical metrics
                ...
                if action == "snapshot":
                    ...
                    print(
                        f"  • Rollback metrics: restored_step={metrics.get('restored_step')}, "

...
def run_max_rollbacks_lockout_validation():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("   ✓ Cooldown is disabled (testing max_rollbacks limit)")
        ...
        if second_abort_context:
            ...
            if abort_message and ("max rollbacks" in abort_message.lower() or "max_rollbacks" in abort_message.lower()):
                ...
                if window_steps and n_rollbacks:
                    print(
                        f"   ✓ Max rollbacks protection context verified: n_rollbacks={n_rollbacks}, window_steps={window_steps}"
                    )
                else:
        ...
        print("  • Second trigger result: ABORT (max_rollbacks)")

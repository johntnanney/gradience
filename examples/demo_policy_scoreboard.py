...
from gradience.vnext.policy_scoreboard import PolicyBenchmarkResult, PolicyScoreboard
...
def demonstrate_policy_scoreboard():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for i, (policy_name, metrics) in enumerate(best_policies):
            ...
            print(
                f"   Bias: {metrics.conservatism_bias:+.1%} ({'Conservative' if metrics.conservatism_bias > 0 else 'Aggressive'})"
            )

...
- Cohort built from high-overlap/non-conflict/loadable/num-label-compatible slice: 12 pairs ({'overlap_gate': 0.2, 'conflict_gate': 0.1, 'n_high': 6, 'n_low': 6}).
...
- High-tail mean delta vs best: -0.0183 (n=6).
- Lower-tail mean delta vs best: -0.1243 (n=6).
- Spearman(delta, OA max score): -0.0176.

...
| `paper/draft_v2_thesis_b_outline.md` | `papers/n134_workshop/draft_v2_thesis_b_outline.md` | **Current revision-planning outline.** Repositions paper from findings (v1) to *Measurement Discipline for ML Diagnostics*, with framework as primary contribution and N134 as worked example. 8–10 page target. |
| `paper/draft_current.md` | `papers/n134_workshop/draft_current.md` | Working file for prose drafting. Currently mirrors `draft_v1.md`; becomes the Thesis B prose draft when prose drafting begins against the v2 outline. |

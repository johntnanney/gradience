...
conceptual reorientation whose consequences include a specific set of reporting
...
This is not merely a bookkeeping oddity of the present run; it is
evidence of a class-level precision risk for rank-based statistics
computed on small-$N$ residuals. The present study demonstrates the risk

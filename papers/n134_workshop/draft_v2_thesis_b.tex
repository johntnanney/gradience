...
Naming what the estimate does not license is itself the framework
move. The temptation to extrapolate a reliability coefficient
beyond the design that produced it is precisely the kind of
measurement-theoretic over-reach the paper argues against
in~\S\ref{sec:framework-reliability}; refusing the extrapolation
in the appendix where the estimate is reported, rather than in a
reviewer-response document or a post-publication correction, is the

...
|---|---:|---:|---:|---:|---|
| `uniform_median` | 1,181,954 | 0.715 | +0.175 | 0.0% | PASS |
| `uniform_p90` | 1,181,954 | 0.715 | +0.175 | 0.0% | PASS |
| `per_layer` | 1,034,498 | 0.710 | +0.170 | 12.5% | PASS |
...
*Generated on 2026-01-13 16:58:59*

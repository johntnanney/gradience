...
- **Validation Level:** Screening
  - *Single seed, 1000 steps (no variance estimation)*
...
|---|---:|---:|---:|---:|---|
| `uniform_median` | 1,181,954 | 0.834 | -0.010 | 33.3% | PASS |
| `uniform_p90` | 1,181,954 | 0.834 | -0.010 | 33.3% | PASS |
...
*Generated on 2026-01-13 18:50:03*
